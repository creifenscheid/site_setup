 ...
 * Output::
 *
 *    <a class="txaa-skip-button my-class" href="#elementId">Label</a>
 *
 */
class SkipButtonViewHelper extends \TYPO3Fluid\Fluid\Core\ViewHelper\AbstractTagBasedViewHelper
{
    ...
    public function render()
    {
        ...
        if (!empty($this->renderChildren())) {
            ...
            $this->tag->setContent(LocalizationUtility::translate('LLL:EXT:a11y/Resources/Private/Language/locallang.xlf:skipToContent'));
        }
